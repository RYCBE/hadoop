...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Job LPAGraph = Job.getInstance(conf, "LPAGraph");
        LPAGraph.setJarByClass(Main.class);
        LPAGraph.setInputFormatClass(KeyValueTextInputFormat.class);
        LPAGraph.setMapperClass(LPAGraph.LPAGraphBuilder.class);
        LPAGraph.setMapOutputKeyClass(Text.class);
        LPAGraph.setMapOutputValueClass(Text.class);
        LPAGraph.setOutputKeyClass(Text.class);
        LPAGraph.setOutputValueClass(Text.class);
        FileInputFormat.addInputPath(LPAGraph, new Path("/home/rycbe/final/output0"));
        FileOutputFormat.setOutputPath(LPAGraph, new Path("/home/rycbe/final/LPAGraph"));
        LPAGraph.waitForCompletion(true);

        for (int i = 0; i < 10; ++i) {
            conf.setInt("LPAInput", i);
            Job LPA = Job.getInstance(conf, "LPA_" + i);

            LPA.setJarByClass(Main.class);
            LPA.setInputFormatClass(KeyValueTextInputFormat.class);
            LPA.setMapperClass(LPARY.LPARYMapper.class);
            // LPA.setReducerClass(LPARY.LPARYReducer.class);
            LPA.setMapOutputKeyClass(Text.class);
            LPA.setMapOutputValueClass(Text.class);
            LPA.setOutputKeyClass(Text.class);
            LPA.setOutputValueClass(Text.class);

            String path = "/home/rycbe/final/LPAGraph_" + i;
            FileInputFormat.addInputPath(LPA, new Path(path));
            FileOutputFormat.setOutputPath(LPA, new Path("/home/rycbe/final/LPAGraph_" + (i + 1)));
            LPA.waitForCompletion(true);
        }

        //
        Job LPAout = Job.getInstance(conf, "LPAout");

        LPAout.setJarByClass(Main.class);
        LPAout.setInputFormatClass(KeyValueTextInputFormat.class);
        LPAout.setMapperClass(LPAout.LPAoutMapper.class);
        // LPA.setReducerClass(LPARY.LPARYReducer.class);
        LPAout.setMapOutputKeyClass(Text.class);
        LPAout.setMapOutputValueClass(Text.class);
        LPAout.setOutputKeyClass(Text.class);
        LPAout.setOutputValueClass(Text.class);

        String path = "/home/rycbe/final/LPAGraph_" + 9;
        FileInputFormat.addInputPath(LPAout, new Path(path));
        FileOutputFormat.setOutputPath(LPAout, new Path("/home/rycbe/final/LPAGraph_output2"));
        LPAout.waitForCompletion(true);
